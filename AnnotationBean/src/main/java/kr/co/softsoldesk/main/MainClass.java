...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		TestBeans2 xmls2 = ctx1.getBean("xmls2",TestBeans2.class);
		System.out.printf("xmls2.data1 : %d\n", xmls2.getData1());
		System.out.printf("xmls2.data2 : %s\n", xmls2.getData2());
		System.out.printf("xmls2.data3 : %s\n", xmls2.getData3());
		System.out.printf("xmls2.data4 : %s\n", xmls2.getData4());
		System.err.println("-----------------------------------------------------");
		...
		TestBeans2 javas2 = ctx2.getBean("javas2", TestBeans2.class);
		System.out.printf("javas2.data1 : %d\n", javas2.getData1());
		System.out.printf("javas2.data2 : %s\n", javas2.getData2());
		System.out.printf("javas2.data3 : %s\n", javas2.getData3());
		System.out.printf("javas2.data4 : %s\n", javas2.getData4());
		System.err.println("-----------------------------------------------------");
		ctx2.close();
